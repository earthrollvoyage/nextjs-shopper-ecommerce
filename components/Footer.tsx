...
const Footer = () => {
  return (
    <div className='w-full bg-hoverBg text-white pt-4 pb-6'>
      <div className='max-w-content-Container max-auto'>
      ...
      <p className='text-sm text-zinc-300 text-center mt-4'>© 2023 Shoppers.com All Rights Reverved.</p>
    </div>
  )
}
